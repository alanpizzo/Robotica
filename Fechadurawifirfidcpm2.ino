...
====================================================================================================*/
#define PINO_SDA 10        //pino SDA do leitor RFID
#define PINO_RST 9         //pino RST do leitor RFID
#define pinoLedvermelho 2  //pino do led vermelho
#define pinoLedverde 3     //pino do led verde
#define pinoTrava 4        //pino do solenóide
...
====================================================================================================*/
  ...
  digitalWrite(pinoLedverde, LOW);     //desliga pinoBuzzer
...
void rfid_func()  //Função para identificação de tags RFID
{
  ...
  if (conteudo.substring(1) == "E7 31 77 53" || conteudo.substring(1) == "60 2F b8 89") {
